...
func (g *GnosisBeaconBlockBody) UnmarshalSSZ(buf []byte) error {
	...
	// Field (4) 'AttesterSlashings'
	{
		...
		g.AttesterSlashings = make([]*phase0.AttesterSlashing, num)
		err = ssz.UnmarshalDynamic(buf, num, func(indx int, buf []byte) (err error) {
			if g.AttesterSlashings[indx] == nil {
				g.AttesterSlashings[indx] = new(phase0.AttesterSlashing)
			}
	...
	// Field (5) 'Attestations'
	{
		...
		g.Attestations = make([]*phase0.Attestation, num)
		err = ssz.UnmarshalDynamic(buf, num, func(indx int, buf []byte) (err error) {
			if g.Attestations[indx] == nil {
				g.Attestations[indx] = new(phase0.Attestation)
			}
	...
	// Field (11) 'BlobKZGCommitments'
	{
		...
		g.BlobKZGCommitments = make([]KZGCommitment, num)
		for ii := 0; ii < num; ii++ {
